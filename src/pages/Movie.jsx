...
function Movie({}) {
  ...
  return (
    <div className=" bg-gray-100 h-full w-4/5 m-auto mt-12 movie-page-shadow flex rounded-2xl ">
      <div className="h-[700px] w-4/6 object-fill rounded-l-2xl border-r-4 border-purple-700">
        <img
      ...
      <div className=" w-2/4 p-6">
        ...
        <span className="text-2xl font-bold text-purple-700">Sinapse:</span>
